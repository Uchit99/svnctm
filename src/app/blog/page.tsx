        ...
        <Container>
          ...
          <div className="mt-5 grid gap-10 lg:grid-cols-[1fr_.9fr] lg:items-end">
            ...
            <div className="relative h-64 overflow-hidden rounded-[1.75rem]">
              <Image src="/images/sanctum-hero.png" alt="Candle and botanical still life" fill priority className="object-cover" />
            </div>
          </div>
        </Container>
      </Section>
        ...
        <Container>
          <article className="grid overflow-hidden rounded-[2rem] bg-svnctm-charcoal text-white lg:grid-cols-2">
            <div className="relative min-h-72">
              <Image src="/images/sanctum-hero.png" alt="Lit candle in a calm home" fill className="object-cover" />
            </div>
