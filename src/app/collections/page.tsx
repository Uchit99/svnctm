...
const collections = [
  { number: '01', name: 'The Quiet Hour', copy: 'Soft florals and warm wood for the beginning and end of the day.', note: 'Lavender · Sandalwood · Amber', image: '/images/products/lodhi-garden-stone.png' },
  { number: '02', name: 'The Sunday Table', copy: 'Fresh, generous scents that make an ordinary room feel open and alive.', note: 'Bergamot · Fig leaf · Cedar', image: '/images/products/lodhi-garden-desk.png' },
  { number: '03', name: 'The Afterlight', copy: 'Smoky, grounded objects for evenings that ask you to stay a little longer.', note: 'Rose · Musk · Incense', image: '/images/products/lodhi-garden-evening.png' },
];

export default function CollectionsPage() {
  return <>
    <Section noPadding className="relative overflow-hidden bg-svnctm-charcoal text-white"><Container className="grid min-h-[65svh] items-end gap-10 py-16 lg:grid-cols-2 lg:py-20"><div className="relative z-10 pb-5"><p className="eyebrow text-svnctm-pink-light">Collections</p><h1 className="mt-5 text-5xl leading-none tracking-[-.05em] sm:text-7xl">A scent for<br />the way you live.</h1><p className="mt-7 max-w-md text-lg leading-8 text-white/65">Three considered worlds, each designed around a different feeling of home.</p></div><div className="relative h-72 overflow-hidden rounded-[2rem] lg:h-[480px]"><Image src="/images/products/lodhi-garden-garden.png" alt="SVNCTM candle in a garden setting" fill priority unoptimized className="object-cover opacity-90" /></div></Container></Section>
